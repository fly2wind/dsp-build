...
@Component
public class RegisterBomReleaseTask implements Task {

    public static final int ORDER = 30;

    private final Releaser releaser;

    public RegisterBomReleaseTask(Releaser releaser) {
    ...
    public String header() {
        return "REGISTER VERSIONS";
    }

    @Override
    public String description() {
        return "Register versions from the BOM";
    }
    ...
    public TaskResult runTask(TaskArguments args) throws RuntimeException {
        ...
        System.out.println("---------------run job3:  git push to remote: us.version=3.1.1");
    ...
    @Override
    public int getOrder() {
        return RegisterBomReleaseTask.ORDER;
    }
}
